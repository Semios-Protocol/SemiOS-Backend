...
public class EthTransactionUtil {
    ...
    @SuppressWarnings("rawtypes")
    public static RawTransaction constructCallContractTransaction(BigInteger nonce, BigInteger gasPrice,
                                                                  BigInteger gasLimit, String contractAddress, BigInteger value, String functionName, Type... functionArguments) {
    ...
    public static RawTransaction constructTransferTransaction(BigInteger nonce, BigInteger gasPrice,
    ...
    public static String signRawTransaction(RawTransaction rawTransaction, long chainId, String keystore,
                                            String password) {
