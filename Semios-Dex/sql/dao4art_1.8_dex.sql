...
alter table user_liquidity_statistics add UNIQUE KEY `user_erc20_address` (`erc20_address`,`user_address`);
...
CREATE TABLE `erc20_liquidity` (
    ...
    `royaltyFee` decimal(16,6) DEFAULT NULL COMMENT 'ERC20的版税收益',
    PRIMARY KEY (id),
