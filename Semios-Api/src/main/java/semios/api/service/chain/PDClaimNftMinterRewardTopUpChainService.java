...
//@Slf4j
//@Service
//public class PDClaimNftMinterRewardTopUpChainService implements SubscriberChainService {
//
//    @Autowired
...
//        log.info("[PDClaimNftMinterRewardTopUpChainService] transactionDao:{}", JacksonUtil.obj2json(transactionDto));
...
//        String ethAmount = CommonUtil.hexToTenString(dataList.get(2));
//
//        Dao dao = daoService.daoDetailByProjectId(project_id);
//        if (dao == null) {
//            log.error("[PDClaimNftMinterRewardTopUpChainService] dao is null transactionDao:{}",
//                    JacksonUtil.obj2json(transactionDto));
//            throw new RuntimeException("dao is null");
//        }
//        BigDecimal tokenNum =
//                new BigDecimal(erc20Amount).divide(new BigDecimal(ProtoDaoConstant.BASIC_RATIO), 18, RoundingMode.FLOOR);
//        if (tokenNum.compareTo(BigDecimal.ZERO) == 0) {
//            log.info("[PDClaimNftMinterRewardTopUpChainService] tokenNum is zero transactionDao:{}",
//                    JacksonUtil.obj2json(transactionDto));
//            return;
//        }
//
