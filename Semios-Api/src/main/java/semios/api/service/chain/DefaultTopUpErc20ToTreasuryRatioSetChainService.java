...
//@Slf4j
//@Service
//public class DefaultTopUpErc20ToTreasuryRatioSetChainService implements SubscriberChainService {
//    @Resource
...
//        // 已经不抛
//        log.info("[DefaultTopUpErc20ToTreasuryRatioSetChainService] transactionDto:{}", JacksonUtil.obj2json(transactionDto));
//
...
//        String ethTransTokenRatio = CommonUtil.hexToTenString(dataList.get(1)); //token to eth 的比例
//
//        // 赋值给聚合dao
//        Dao dao = daoService.getDaoByProjectId(projectId, DaoTogetherTypeEnum.IS_TOGETHER_DAO.getStatus());
//        if (dao == null) {
//            log.error("[DefaultTopUpErc20ToTreasuryRatioSetChainService] dao not find projectId:{}", projectId);
//            throw new RuntimeException("DefaultTopUpErc20ToTreasuryRatioSetChainService cannot find dao");
//        }
//
