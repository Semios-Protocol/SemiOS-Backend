...
public class WorkServiceImpl extends ServiceImpl<WorkMapper, Work> implements IWorkService {
    ...
    @Override
    public Integer selectNftAmountsExceptZeroNft(String daoId) {
        return workMapper.selectNftAmountsExceptZeroNft(daoId);
    }

    @Override
    public int selectDrbNftCountByDaoIdExceptZeroNft(String daoId, Integer drb) {
        return workMapper.selectDrbNftCountByDaoIdExceptZeroNft(daoId, drb);
    }
}
