...
public class JjwtUtil {
    ...
    // 加密密文，私钥
    public static final String JWT_SECRET = "semiosapiciphertext";
...
//	public static final long EXPIRE_TIME = 7 * 24 * 3600 * 1000; // 一个星期
    ...
    public static SecretKey generalKey() {
        // 本地的密码解码
        byte[] encodedKey = BaseEncoding.base64().decode(JWT_SECRET);
...
//		header.put("alg", "HS256");
        ...
        claims.put("username", "semios");
        claims.put("password", "semiosapi");
