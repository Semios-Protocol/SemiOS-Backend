...
public class Generator {
    ...
    public static void main(String[] args) {
        FastAutoGenerator
                .create("jdbc:mysql://127.0.0.1:3306/dao4art?useUnicode=true&characterEncoding=utf-8", "root", "xb910716")
                .globalConfig(builder -> {
                    builder.author("xiangbin") // 设置作者
                            // .enableSwagger() // 开启 swagger 模式
                            .fileOverride() // 覆盖已生成文件
                            .commentDate("").outputDir("/Users/xiangbin/tools"); // 指定输出目录
                }).packageConfig(builder -> {
                    builder.parent("semios.api") // 设置父包名
                    ...
                    builder.addInclude("dao_daily_statistics"); // 设置需要生成的表名
