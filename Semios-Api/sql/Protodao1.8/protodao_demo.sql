...
VALUES ('0xC1634B63DbF98d844B6467B9e5290ce8b9fD0445','0x6aa2104d183ed7fffe1e940387d0c32625ecd6a56f93f815bac650cb373ef1af','','http://172.31.31.55:9480/transaction/call',NULL,'NewSemiOsPlan',0,0,3);

-- 添加订阅事件 plan追加token
INSERT INTO `protodao`.`subscribe` (`contract_address`,`topics`,`from_block`,`receive_address`,`filter_id`,`trade_type`,`is_del`,`status`,`order_init`)
VALUES ('0xC1634B63DbF98d844B6467B9e5290ce8b9fD0445','0xbbb2633759ec4150dc2586285718c49f18853666eff18aad457c64ad8f196f7d','','http://172.31.31.55:9480/transaction/call',NULL,'PlanTotalRewardAdded',0,0,3);

-- 添加订阅事件 用户Claimed奖励的信号事件
INSERT INTO `protodao`.`subscribe` (`contract_address`,`topics`,`from_block`,`receive_address`,`filter_id`,`trade_type`,`is_del`,`status`,`order_init`)
VALUES ('0xC1634B63DbF98d844B6467B9e5290ce8b9fD0445','0xfbe0524fbfedf9d86084e1fe0061e119a6decd7bbbeb73744bd1bd7318e6ad76','','http://172.31.31.55:9480/transaction/call',NULL,'PlanRewardClaimSignal',0,0,3);


-- TopUpAccountUpdated链上余额变更
INSERT INTO `protodao`.`subscribe` (`contract_address`,`topics`,`from_block`,`receive_address`,`filter_id`,`trade_type`,`is_del`,`status`,`order_init`)
VALUES ('0xC1634B63DbF98d844B6467B9e5290ce8b9fD0445','0xfc1f5941de2e389cc0deb38e38420424a2e876572dea8cfb2a297b39b022848a','','http://172.31.31.55:9480/transaction/call',NULL,'TopUpAccountUpdated',0,0,3);
