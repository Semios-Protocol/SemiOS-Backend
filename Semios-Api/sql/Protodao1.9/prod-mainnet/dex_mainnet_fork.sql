# 数据全部清除，表结构从test中取
CREATE SCHEMA `dex_fork` DEFAULT CHARACTER SET utf8mb4;

create table if not exists dex_fork.erc20_liquidity
(
...
create table if not exists dex_fork.liquidity_daily_statistics
(
    id                      int auto_increment comment 'id'
        primary key,
    erc20_address           varchar(128)                       null comment 'erc20地址',
...
create table if not exists dex_fork.liquidity_price_record
(
    id             int auto_increment comment 'id'
        primary key,
...
create table if not exists dex_fork.liquidity_transaction
(
    id                int auto_increment comment 'id'
        primary key,
    erc20_address     varchar(128)                       null comment 'erc20地址',
...
create table if not exists dex_fork.user_liquidity_statistics
(
    id                 int auto_increment comment 'id'
        primary key,
    erc20_address      varchar(128)                       null comment 'erc20地址',
...
create table if not exists dex_fork.subscribe
(
    id               int auto_increment comment 'id'
        primary key,
