...
create table if not exists dao4art_1.erc20_liquidity
(
...
create table if not exists dao4art_1.liquidity_daily_statistics
(
    id                      int auto_increment comment 'id'
        primary key,
    erc20_address           varchar(128)                       null comment 'erc20地址',
...
create table if not exists dao4art_1.liquidity_price_record
(
    id             int auto_increment comment 'id'
        primary key,
...
create table if not exists dao4art_1.liquidity_transaction
(
    id                int auto_increment comment 'id'
        primary key,
    erc20_address     varchar(128)                       null comment 'erc20地址',
...
create table if not exists dao4art_1.user_liquidity_statistics
(
    id                 int auto_increment comment 'id'
        primary key,
    erc20_address      varchar(128)                       null comment 'erc20地址',
...
create table if not exists dao4art_1.subscribe
(
    id               int auto_increment comment 'id'
        primary key,
