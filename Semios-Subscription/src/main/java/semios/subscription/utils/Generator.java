...
public class Generator {
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/subscribe?useUnicode=true&characterEncoding=utf-8", "root",
                    ...
                    builder.parent("semios.subscription.infura") // 设置父包名
                    ...
                    builder.addInclude("sub_num_value"); // 设置需要生成的表名
