CREATE SCHEMA `protodao` DEFAULT CHARACTER SET utf8mb4;

create table protodao.canvas
(
...
create table protodao.canvas_drb_statistics
(
    id                  int auto_increment comment 'id'
        primary key,
...
(
    ...
    comment 'nft plan奖励分配记录';

create table protodao.dao
(
    id                               int auto_increment comment 'id'
        primary key,
...
create table protodao.dao_allocation_amount
(
    id               int auto_increment comment 'id'
        primary key,
...
create table protodao.dao_allocation_strategy
(
    id                 int auto_increment comment 'id'
        primary key,
...
create table protodao.dao_append_token_log
(
    id                  int auto_increment comment 'id'
        primary key,
    dao_id              int                                null comment 'dao id',
...
create table protodao.dao_daily_statistics
(
    id                            int auto_increment comment 'id'
        primary key,
    dao_id                        int                                null comment 'dao的id',
...
create table protodao.dao_drb_statistics
(
    id                    int auto_increment comment 'id'
        primary key,
    dao_id                int                                null comment 'Dao id',
    ...
    comment 'Dao在drb的统计信息';

create table protodao.dao_strategy
(
    id               int auto_increment comment 'id'
        primary key,
...
create table protodao.favorites
(
    id           int auto_increment comment 'id'
        primary key,
...
create table protodao.maker_info_statistics
(
    id                   int auto_increment comment 'id'
        primary key,
    ...
    create_time          datetime default CURRENT_TIMESTAMP null comment '创建时间',
    constraint idx_record_time_project_id
        unique (record_time, project_id)
)
    comment 'seed node maker统计信息';
...
(
    ...
    project_id                  varchar(200)                         not null comment 'dao project id',
    node_type                   int(1)                               not null comment 'node类型',
    generate_work_id            int                                  not null comment '创建nodes生成的work id',
    generate_erc721_address     varchar(200)                         not null comment 'erc721 address',
    generate_erc721_token_id    varchar(200)                         not null comment 'erc721 token id',
    permissions_type            int                                  not null comment '权限类型',
    permissions_dao_id          int                                  not null comment '这个权限下的nft对应的dao id',
    permissions_work_id         int                                  not null comment '这个权限下的nft对应的work id',
    permissions_erc721_address  varchar(200)                         not null comment 'erc721 address',
    permissions_erc721_token_id varchar(200)                         not null comment 'erc721 token id',
    transaction_hash            varchar(66)                          null comment '记录的交易hash',
    is_valid                    tinyint(1) default 1                 not null comment '是否有效 1-有效 0-无效',
...
create table protodao.shutdown_record
(
    id               int auto_increment comment 'id'
        primary key,
...
create table protodao.subscribe
(
    id               int auto_increment comment 'id'
        primary key,
...
create table protodao.subscribe_bak
(
...
create table protodao.token_received_record
(
    id                int auto_increment comment 'id'
        primary key,
...
create table protodao.user_harvest_token
(
    id                    int auto_increment comment 'id'
        primary key,
    dao_id                int                                          not null comment 'dao id',
...
create table protodao.user_topup_harvest
(
    id                 int auto_increment comment 'id'
        primary key,
    ...
    comment 'topup模式用户拥有eth和token的数量';

create table protodao.white_list
(
    id              int auto_increment comment 'id'
        primary key,
    user_address    varchar(42)                        null comment '用户地址',
...
create table protodao.work
(
    id                  int auto_increment comment 'id'
        primary key,
    work_number         int                                   null comment 'work编号',
    erc721_token        varchar(200)                          null,
...
(
    ...
    comment 'topup模式work下的eth和token的数量';
